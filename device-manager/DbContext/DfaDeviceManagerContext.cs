...
public partial class DfaDeviceManagerContext : DbContext
{
    public DfaDeviceManagerContext()
    {
    }

    public DfaDeviceManagerContext(DbContextOptions<DfaDeviceManagerContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeviceType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__DeviceTy__737584F64C648D0D").IsUnique();
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            entity.HasIndex(e => e.PassportNumber, "UQ__Person__45809E718F531216").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__Person__85FB4E38600D2AC1").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Person__A9D105340F923EE2").IsUnique();
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Position__737584F6B4CDEB70").IsUnique();
